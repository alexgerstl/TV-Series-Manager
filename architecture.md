...
| **Backend** | Electron (main process) + Node.js 22 LTS or newer + TypeScript (strict) | Originally targeted Node 20 LTS; updated 2026-07-10 per decisions.md — Node 20 reached EOL in April 2026, and `better-sqlite3` Node 24 prebuild support requires this bump. |
